# Lumen Governance: 살아있는 윤리/정책을 위한 운영 규칙

이 문서는 루멘의 최소 헌법과 윤리·철학을 "고정된 교의"가 아니라 "검증 가능한 가설"로 다루기 위한 거버넌스 원칙과 변경 절차를 정의합니다.
...
## 메타데이터 (policy/lumen_constitution.json)
...
- 버전/검토 갱신: `scripts/bump_lumen_constitution.ps1` — 버전 증분, last_reviewed 업데이트, 선셋/주기 설정, 변경 노트 기록
