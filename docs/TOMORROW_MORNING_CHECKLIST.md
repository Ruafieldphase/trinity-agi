...
- [ ] Core (997 MB, 21,842 msgs) - Observation Phase
- [ ] Core (63 MB, 848 msgs) - Resonance Bridge
...
### **Week 1 목표: Core Dataset Parsing**

#### **Step 1: Core 폴더 구조 분석**

```powershell
# Core 파일 목록
Get-ChildItem C:\workspace\agi\ai_binoche_conversation_origin\Core -File | 
...
```python
# fdo_agi_repo/scripts/trinity/Core_parser.py
# - Markdown 파일 파싱
# - 메시지 추출 (user/assistant 구분)
# - 턴 수 계산
# - 키워드 추출 (AGI, Vertex, Core)
# - JSONL 출력
```
...
09:15-10:00  → Core 폴더 구조 분석 + Parser 설계
10:00-12:00  → Core Parser 구현 (v1)
12:00-13:00  → 점심
13:00-15:00  → Core Parser 테스트 + 디버깅
