...
class TestCoreBridge(unittest.TestCase):
    def setUp(self):
        self.client = CoreBridgeClient(workspace_root="c:/workspace")
    ...
    def test_send_and_receive(self):
        ...
        def mock_responder():
            ...
            if found and target_file:
                ...
                resp_data = {
                    "request_id": req_id,
                    "answer": "This is a mock response from Core.",
        ...
        if response:
            self.assertEqual(response["answer"], "This is a mock response from Core.")
