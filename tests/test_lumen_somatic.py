...
from fdo_agi_repo.orchestrator.lumen_system import LumenSystem, BodySignals
...
def test_somatic_anomaly():
    lumen = LumenSystem(workspace_root)
    ...
    for i in range(20):
        ...
        lumen.signal_history.append(signal)
        
    # 2. Test Normal Case
    logger.info("Phase 2: Testing Normal Input...")
    # Inject current mock body signal
    lumen.collect_body_signals = lambda: BodySignals(
