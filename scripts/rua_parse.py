#!/usr/bin/env python3
"""Flatten ChatGPT Rua conversations.json into JSONL/CSV rows.

The Rua export stores each conversation as a mapping tree. This script walks
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser.add_argument(
        "--input",
        default="ai_binoche_conversation_origin/rua/origin/conversations.json",
        help="Path to conversations.json export",
    )
    parser.add_argument(
        "--out-jsonl",
        default="outputs/rua/rua_conversations_flat.jsonl",
