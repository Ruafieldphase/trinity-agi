...
Syncs:
- ~/agi/outputs/thought_stream_latest.json -> <workspace_root>/outputs/thought_stream_latest.json
- ~/agi/outputs/feeling_latest.json -> <workspace_root>/outputs/feeling_latest.json (if available)
    ...
    while True:
        try:
            ...
            while True:
                ...
                sync_file(
                    sftp,
                    "/home/bino/agi/fdo_agi_repo/memory/resonance_ledger.jsonl",
                    LOCAL_ROOT / "fdo_agi_repo" / "memory" / "resonance_ledger.jsonl",
                )
