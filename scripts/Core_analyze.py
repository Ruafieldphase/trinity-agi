#!/usr/bin/env python3
"""Analyze Core Dataset and generate statistics dashboard."""
import json
import sys
...
def generate_markdown_report(stats: Dict[str, Any], output_path: Path):
    ...
    md = f"""# Core Dataset Analysis Report
...
def main():
    # Paths
    input_jsonl = WORKSPACE_ROOT / "outputs" / "core_dataset_parsed.jsonl"
    output_json = WORKSPACE_ROOT / "outputs" / "core_analysis.json"
    output_md = WORKSPACE_ROOT / "outputs" / "core_analysis.md"
