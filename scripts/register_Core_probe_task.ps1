# Register/Unregister a Windows Scheduled Task to run Core probe collector periodically
...
param(
    ...
    [switch]$Status,
    [string]$TaskName = 'CoreProbeCollector',
...
$collector = Join-Path $PSScriptRoot 'core_probe_collector.ps1'
