#!/usr/bin/env python3
"""
Core's Rhythm Observer - Core의 리듬 관찰자

Core의 시선으로 시스템의 리듬을 관찰하고 측정합니다.
...
class CoreRhythmObserver:
    ...
    def _latency_to_feeling(
        ...
        """
        baseline = self.core_baseline.get(channel, 100.0)
    ...
    def _save_report(self, report: Dict):
        """보고서 저장"""
        # JSON
        json_path = self.output_dir / "core_rhythm_observation_latest.json"
        ...
        # Markdown
        md_path = self.output_dir / "core_rhythm_observation_latest.md"
...
def main():
    ...
    observer = CoreRhythmObserver(metrics_path)
