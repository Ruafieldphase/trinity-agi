#!/usr/bin/env python3
"""
Summarize outputs/lumen_probe_log.jsonl into ASCII-safe digest and JSON.
...
- outputs/lumen_probe_summary_latest.md (ASCII digest)
"""
import argparse
import json
...
LOG = ROOT / "outputs" / "lumen_probe_log.jsonl"
OUT_JSON = ROOT / "outputs" / "lumen_probe_summary_latest.json"
OUT_MD = ROOT / "outputs" / "lumen_probe_summary_latest.md"
...
def write_outputs(summary: Dict[str, Any]) -> None:
    ...
    # MD
    lines: List[str] = []
    lines.append("[LUMEN PROBE SUMMARY - ASCII SAFE]")
    lines.append("")
    ...
    lines.append("---")
    lines.append("")
    lines.append("Append-only log: outputs/lumen_probe_log.jsonl")
