...
$action = New-ScheduledTaskAction -Execute "$WorkspaceRoot\fdo_agi_repo\.venv\Scripts\pythonw.exe" -Argument "$WorkspaceRoot\scripts\meta_supervisor.py" -WorkingDirectory "$WorkspaceRoot"
...
$action = New-ScheduledTaskAction -Execute "$WorkspaceRoot\fdo_agi_repo\.venv\Scripts\pythonw.exe" -Argument "$WorkspaceRoot\scripts\goal_executor_monitor.py" -WorkingDirectory "$WorkspaceRoot"
