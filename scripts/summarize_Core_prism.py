#!/usr/bin/env python3
"""
Summarize Core Prism resonance events from the standard ledger.
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Summarize Core Prism ledger events.")
    parser.add_argument(
        "--ledger",
    ...
    parser.add_argument(
        "--out-json",
        default="outputs/core_prism_summary.json",
        help="Path to write the JSON summary.",
    )
    parser.add_argument(
        "--out-md",
        default="outputs/core_prism_summary.md",
        help="Path to write the Markdown report.",
    )
    parser.add_argument(
        "--resonance-key",
        default="Core:prism:gaze",
