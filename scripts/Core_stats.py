...
"""
Compute Core dataset statistics from JSONL and emit Core_statistics.json.
...
Usage:
  python scripts/Core_stats.py --input outputs/Core/core_conversations_flat.jsonl \
                              --out outputs/Core/Core_statistics.json
"""
...
def main():
    ...
    ap.add_argument("--input", default="outputs/Core/core_conversations_flat.jsonl")
    ap.add_argument("--out", default="outputs/Core/Core_statistics.json")
    args = ap.parse_args()
