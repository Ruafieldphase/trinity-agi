---
title: 고마워 퍼플 그리고 퍼플 대규모 업데이트가 있었던 거 같은 데 유료 사용자들만 아직 사용할 수 있는 거지 유료 사용자가 아니고 30 만원짜리 요금제를 사용 하면은 되는 거 같던데 우리 리듬 에서 그 요금제가 도움이 될까
date: 2025-07-03
...
mode: COPILOT
---
# 고마워 퍼플 그리고 퍼플 대규모 업데이트가 있었던 거 같은 데 유료 사용자들만 아직 사용할 수 있는 거지 유료 사용자가 아니고 30 만원짜리 요금제를 사용 하면은 되는 거 같던데 우리 리듬 에서 그 요금제가 도움이 될까

### 퍼플(Perplexity) 대규모 업데이트와 30만원 요금제(맥스) 요약

#### 1. 대규모 업데이트 및 유료 사용자 우선 적용

- 최근 퍼플(Perplexity)은 대규모 업데이트를 통해 **신규 기능**(예: 랩스, 코멧 브라우저, 고급 AI 모델 등)과 **브랜드 리뉴얼**을 진행했습니다.
...
| 신기능 조기 접근    | 코멧(Comet) 등 최신 기능을 누구보다 먼저 체험 가능                                      |
...
8. [엔씨(NC) 〈퍼플〉, 신규 기능 추가와 브랜드 리뉴얼로 새단장](https://about.ncsoft.com/news/article/purple-update-230913)
9. [엔씨소프트, 9월 대규모 업데이트로 게임 라인업 강화](https://news.nate.com/view/20240925n31887)
10. [엔씨 '퍼플' 신규 기능 추가와 브랜드 리뉴얼로 새단장](https://www.newswire.co.kr/newsRead.php?no=974295)
...
13. [엔씨 '퍼플', 신규 기능 추가·브랜드 리뉴얼 '새단장'](http://www.startuptoday.co.kr/news/articleView.html?idxno=138766)
...
16. [엔씨소프트 퍼플, PC게임 신작 '마블스 스파이더맨 2' 출시](https://www.youthdaily.co.kr/news/article.html?no=179375)
...
19. [엔씨소프트 '퍼플', 사용자 편의성 개선 업데이트 실시](https://www.inven.co.kr/webzine/news/?news=268547)
...
- 유료 사용자만 사용할 수 있는 퍼플 업데이트가 리듬에 도움이 될까
- 30만원 요금제가 우리 리듬 서비스에 어떤 혜택을 줄까
- 퍼플의 신규 기능들이 우리 게임 플레이에 어떤 영향을 미칠까
- 유료 요금제 선택이 리듬의 사용자 경험 향상에 기여할까
- 퍼플 대규모 업데이트와 내 서비스 연계 가능성은 무엇일까
