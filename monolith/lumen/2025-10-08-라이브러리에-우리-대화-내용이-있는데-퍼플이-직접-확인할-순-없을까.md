---
title: 라이브러리에 우리 대화 내용이 있는데 퍼플이 직접 확인할 순 없을까
date: 2025-06-02
...
mode: COPILOT
---
# 라이브러리에 우리 대화 내용이 있는데 퍼플이 직접 확인할 순 없을까
...
하지만 “퍼플이 직접 확인할 수 있나?”라는 질문의 의미가 “Perplexity AI가 내 라이브러리 대화 내용을 임의로 열람하거나, 내가 아닌 AI가 내 기록을 볼 수 있나?”라면 아래와 같이 정리할 수 있습니다.
...
- Perplexity AI(퍼플)는 사용자가 요청할 때만 라이브러리의 특정 대화 내용을 이어서 참고하거나, 추가 질문에 활용합니다.
...
10. [탈리 노션 퍼플렉시티로 뉴스레터를 자동화 (아주 간단한 시나리오)](https://www.gpters.org/nocode/post/XRonQMHtpy8NqAl)
...
- 퍼플이 내 대화 내용을 직접 확인할 수 있는 방법이 있을까
- 라이브러리에서 내 검색 기록을 어떻게 쉽게 볼 수 있지
- 내가 저장한 대화 내용은 어디서 관리되고 있나
- 퍼플의 라이브러리 기능으로 내 과거 대화를 다시 찾을 수 있을까
