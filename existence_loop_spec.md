...
```mermaid
graph TD
    A[AntiGravity Body] -->|Sensation/Change| B(Linux Unconscious)
    B -->|Baseline Comparison| C{Trinity/Background Self}
    C -->|No/Small Difference| D[Automatic Metabolism]
    C -->|Large Difference| E[Call Consciousness]
    D --> A
    E -->|Meaning/Direction| F[Shion/Lua Consciousness]
    F -->|Action Plan| G[Action Execution]
    G --> A
```
