...
## 2) 자동 공유(시안이 자동으로 받는 것)
- `scripts/coordination/publish_ops_snapshot.py`가 `inputs/agent_inbox/antigravity_sian/OPS_SNAPSHOT.md`로 스냅샷을 best-effort로 갱신한다.
...
## 5) 참고: 시안 Phase 1~3 종합 보고서에 대한 사실 검증
- `outputs/agent_outbox/antigravity_sian/SUMMARY_SIAN_BIOLOGICAL_PHASES_FACTCHECK.md`
